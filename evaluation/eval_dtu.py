...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', type=str, default='/data/yesheng/data/SampleSet/MVS_Data')
    ...
    GT_DIR = "/data/yesheng/data/Points/stl"
    ...
    for scan in scans:
        ...
        args.data = os.path.join(base_dir, "final_dtu_scan%03d.ply" % scan)
        print(args.data)
        if not os.path.exists(args.data):
            continue

        args.gt = os.path.join(GT_DIR, "stl%03d_total.ply" % scan)
        args.vis_out_dir = os.path.join(base_dir, "scan{}_vis".format(scan))
        args.scan = scan
        os.makedirs(args.vis_out_dir, exist_ok=True)
